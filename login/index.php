                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-4 mx-auto">
                        ...
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            <strong>Registrasi akun berhasil, </strong> <?= $_SESSION['message'] ?>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        <?php 
                        $_SESSION['alert'] = null;
                        ...
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <form class="pt-3" action="login.php" method="POST">
                                <div class="form-group">
                                    <input type="text" class="form-control " name="akun" id="exampleInputUsername1"
                                ...
                                <div class="text-center mt-4 font-weight-light"> Belum punya akun? silahkan <a href="../register" class="text-primary">Register</a>
                                </div>
