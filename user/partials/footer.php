  ...
  <div class="d-sm-flex justify-content-center justify-content-sm-between">
    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <?= date('Y') ?> Qhaerul. All rights reserved.</span>
    ...
    <script src="../../assets/admin/vendors/datatables.net-bs5/dataTables.bootstrap5.js"></script>
